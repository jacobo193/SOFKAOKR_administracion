...
public class LoginController {
    ...
    public static WebElement wlecomeMassageModal(WebDriver driver){
    ...
    public static void clickAccpetButton(WebDriver driver) {
        HomePage homePage = new HomePage(driver);
    ...
    public static WebElement nosotrosMasage(WebDriver driver){
